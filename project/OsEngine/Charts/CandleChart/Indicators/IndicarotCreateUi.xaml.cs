...
namespace OsEngine.Charts.CandleChart.Indicators
{
    ...
    public partial class IndicarotCreateUi
    {
        ...
        public IndicarotCreateUi(ChartCandleMaster chartMaster)
        {
            ...
            _gridViewIndicators.Rows.Add("KalmanFilter2");
        ...
        private void ButtonAccept_Click(object sender, RoutedEventArgs e)
        {
            ...
            if (_gridViewIndicators.SelectedCells[0].Value.ToString() == "KalmanFilter2")
            {
                string name = "";

                for (int i = 0; i < 30; i++)
                {
                    if (_chartMaster.IndicatorIsCreate(_chartMaster.Name + "KalmanFilter2" + i) == false)
                    {
                        name = "KalmanFilter2" + i;
                        break;
                    }
                }
                IndicatorCandle = new KalmanFilter2(_chartMaster.Name + name, true);
                _chartMaster.CreateIndicator(IndicatorCandle, areaName);
            }
